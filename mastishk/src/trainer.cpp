...
float *ValueOfNetWorkCalculater(Layer *currentLayer, float *input) {
  ...
  ValueOfNetWorkCalculater(currentLayer->m_previousLayer, input);
...
void trainAndSaveModel() {
  ...
  // training section comes
  // here:-----------------------------------------------------------------------------<start>

  // opening the binary file
  std::ifstream imagefile("../../dataSetsForTraining/train-images.idx3-ubyte",
                          std::ios::binary);
  // opening the lable file
  std::ifstream lablefile("../../dataSetsForTraining/train-labels.idx1-ubyte",
                          std::ios::binary);
  ...
  int label;
  int NthImageTraining = 0;
  unsigned char anotherLable;
  while (imagefile.read(reinterpret_cast<char *>(imageData), 784) &&
         lablefile.read(reinterpret_cast<char *>(&anotherLable), 1)) {
    label = anotherLable;
    // DATA preparation
    // part..................................................................................<start>
    ...
    // DATA preparatoin part
    // ..................................................................................<end>

    // Looping for the weights and biases of a
    // layer.......................................................................<star>
    ...
    while (LayerCommonPointerBackup->m_connectedPrevious) {
      ...
      for (int i = 0;
           i < (LayerCommonPointerBackup->m_nodes * Previous->m_nodes); i++) {
        float Current, lower, upper;
        while (!(Current <= lower && Current <= upper)) {

          float *OutputOfTheNetwork =
              ValueOfNetWorkCalculater(LayerCommonPointerBackup, input);
    ...
    std::cout << "NthImageTraining: " << NthImageTraining << std::endl;
    NthImageTraining++;
  }
}
